...
def problem1(circle, rectangle, color, length, window):
    ...
    line1=rg.Line(circle.center,rectangle.get_center())
    line1.color=color
    line1.thickness=circle.outline_thickness
    line1.attach_to(window)

    startpoint=rg.Point(line1.get_midpoint().x,line1.get_midpoint().y+length/2)
    endpoint=rg.Point(line1.get_midpoint().x,line1.get_midpoint().y-length/2)
    line2=rg.Line(startpoint,endpoint)
